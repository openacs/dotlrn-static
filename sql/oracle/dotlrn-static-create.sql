...
begin
	...
	foo := acs_sc_impl.new (
		...
		impl_pretty_name => 'dotlrn_static',
		impl_owner_name => 'dotlrn_static'
	);
    ...
    foo := acs_sc_impl.new_alias (
        ...
        impl_alias => 'dotlrn_static::add_portlet',
        impl_pl => 'TCL'
    );
    ...
    foo := acs_sc_impl.new_alias (
        ...
        impl_alias => 'dotlrn_static::remove_portlet',
        impl_pl => 'TCL'
    );
    ...
    foo := acs_sc_impl.new_alias (
        ...
        impl_alias => 'dotlrn_static::clone',
        impl_pl => 'TCL'
    );
